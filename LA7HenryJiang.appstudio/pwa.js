...
const cacheName = 'learningactivityweeksevensedlacekproject-2021-03-22 21:24:50.540994'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'learningactivityweeksevensedlacekproject'.length) === 'learningactivityweeksevensedlacekproject') {
