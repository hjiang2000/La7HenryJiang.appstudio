...
const cacheName = 'LA7HenryJiang-2021-03-21 15:07:48.234776'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LA7HenryJiang'.length) === 'LA7HenryJiang') {
